...
Para actualizar, repetí el comando de instalación global. Para instalar una copia local del código: `npm ci`, `npm pack`, `npm install -g ./orquesta-local-0.2.5.tgz`.
