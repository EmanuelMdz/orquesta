...
2. Ejecutá `npx --yes --package=git+https://github.com/EmanuelMdz/orquesta.git#v0.2.0 orquesta install`. En PowerShell podés usar `npx.cmd`. El instalador deja una copia global permanente y registra las skills desde esa copia. Si el repo es privado, el usuario necesita acceso de GitHub.
